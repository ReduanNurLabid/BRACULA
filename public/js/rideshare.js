document.addEventListener('DOMContentLoaded', () => {
    ...
    async function checkForNewRequests() {
        ...
        try {
            const response = await fetch(`${BASE_URL}/api/rides/rides.php?user_id=${currentUser.user_id}`);
    ...
    offerRideForm.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${BASE_URL}/api/rides/rides.php`, {
                method: 'POST',
                headers: {
    ...
    requestRideForm.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            // Send request
            const response = await fetch(`${BASE_URL}/api/rides/ride_requests.php`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (result.status === 'success') {
                ...
                const rideResponse = await fetch(`${BASE_URL}/api/rides/rides.php?ride_id=${requestData.ride_id}`);
    ...
    reviewDriverForm.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            // Send review
            const response = await fetch(`${BASE_URL}/api/rides/driver_reviews.php`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function fetchMyRequests() {
        ...
        try {
            const response = await fetch(`${BASE_URL}/api/rides/ride_requests.php?user_id=${currentUser.user_id}`);
            const result = await response.json();
    ...
    window.viewRequests = async function(rideId) {
        try {
            ...
            const response = await fetch(`${BASE_URL}/api/rides/ride_requests.php?ride_id=${rideId}`);
            const result = await response.json();
    ...
    async function getRequestInfo(requestId) {
        try {
            const response = await fetch(`${BASE_URL}/api/rides/ride_requests.php?request_id=${requestId}`);
            const result = await response.json();
