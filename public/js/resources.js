document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadMaterials(filters = {}) {
        try {
            ...
            const url = `${BASE_URL}/api/resources/get_materials.php${queryParams ? '?' + queryParams : ''}`;
    ...
    function handleDownload(event) {
        ...
        downloadLink.href = `${BASE_URL}/api/resources/download_material.php?id=${materialId}`;
    ...
    async function handleUploadMaterial(e) {
        ...
        if (file) {
            try {
                ...
                const response = await fetch(`${BASE_URL}/api/resources/upload_material.php`, {
                    method: 'POST',
                    body: formData
                });
